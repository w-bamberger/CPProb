...
BOOST_AUTO_TEST_CASE(Parameters)
{
  ...
  BayesianNetwork bn;
  typedef cont::map<DiscreteRandomVariable, DirichletProcessParameters::ConstChildren> ChildLists;
...
//  condition1 = RandomInteger(condition1.name(), 1, 0);
...
//  condition2 = RandomInteger(condition2.name(), 1, 0);
